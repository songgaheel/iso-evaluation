...
async function CreateWorkEvaluationStep1(req, res) {
    const work = req.body;
    const data = await Work.find({ _id: work._id })
        .populate('company')
        .populate('user')
        .populate('department');
...
module.exports.CreateWorkEvaluationStep1 = CreateWorkEvaluationStep1;